  ...
  return (0, import_jsx_runtime9.jsx)(React12.Fragment, {
    children: xTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime9.jsxs)("g", {
        ...
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime9.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
    ...
    children: xTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime10.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime10.jsx)(Tick, _extends({
          y2: tickYSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime10.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: labelPositionY
        }, axisTickLabelProps, {
...
var _excluded9 = ["axis"];
var _excluded24 = ["scale", "tickNumber", "reverse"];
...
function ChartsXAxisImpl(_ref) {
  ...
  return (0, import_jsx_runtime11.jsxs)(XAxisRoot, {
    ...
    }, slotProps == null ? void 0 : slotProps.axisLine)), children, label && (0, import_jsx_runtime11.jsx)("g", {
...
function ChartsGroupedYAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime14.jsx)(React18.Fragment, {
    children: yTicks.map((item, index) => {
      const {
        offset: tickOffset,
        labelOffset
      ...
      return (0, import_jsx_runtime14.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime14.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime14.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
var _excluded25 = ["scale", "tickNumber", "reverse"];
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime19.jsxs)(React23.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)(React24.Fragment, {
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(React27.Fragment, {
    children: yTicks.map(({
      ...
      var _a;
      return (0, import_jsx_runtime23.jsx)(GridLine, {
        y1: offset,
        y2: offset,
        x1: start,
        x2: end,
...
var BAR_CHART_PLUGINS = [useChartZAxis, useChartCartesianAxis, useChartInteraction, useChartHighlight, useChartKeyboardNavigation];

// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded13 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend", "showToolbar"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React29.useMemo(() => [{
  ...
  const defaultBandYAxis = React29.useMemo(() => [{
  ...
  const seriesWithDefault = React29.useMemo(() => series.map((s) => _extends({
    type: "bar"
  }, s, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React29.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React29.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
var BarChart = React30.forwardRef(function BarChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  return (0, import_jsx_runtime25.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime25.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime25.jsx)(Toolbar, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime25.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime25.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime25.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime25.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime25.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime25.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime25.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
        })), (0, import_jsx_runtime25.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime25.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime25.jsx)(Tooltip, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.tooltip))]
    }))
  }));
});
